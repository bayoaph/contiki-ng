 ...
 */
/*
ANSWER: Running this, makes it that every 4 seconds, a message is broadcasted for every even node. 
Even nodes gets the value of their temperature sensor, while odd nodes they have a temperature of 0 as they don't have a sensor
*/
