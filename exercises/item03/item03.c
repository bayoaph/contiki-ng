...
#include <string.h>
//#include "net/stack.h"  // Corrected include for the stack
#include "dev/button-sensor.h"
#include "dev/leds.h"
//#include "dev/light-sensor.h" //dev/light.h
#include "node-id.h" /* get a pointer to the own node id */
#include "arch/dev/sensor/sht11/sht11-sensor.h" //dev/zoul-sensors.h
