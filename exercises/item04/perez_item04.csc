...
<simconf version="2023090101">
    ...
    <motetype>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="58.66382404221447" y="77.04541093852514" />
        </interface_config>
        <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.9090909090909091 0.0 0.0 0.9090909090909091 140.6692508707141 102.95871732861352</viewport>
    </plugin_config>
  ...
  <plugin>
    ...
    <bounds x="55" y="454" height="300" width="350" z="2" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInterfaceViewer
    <mote_arg>0</mote_arg>
    ...
    <bounds x="428" y="443" height="300" width="350" />
  </plugin>
</simconf>
