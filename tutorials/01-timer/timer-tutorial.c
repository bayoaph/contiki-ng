...
/* Function prototypes with updated signatures */
void ctimer_function(void *data);
void rtimer_function(struct rtimer *rt, void *data);
...
PROCESS_THREAD(process, ev, data) {
  ...
  printf("stimer object expired\n");

  /* Etimers can generate events. This helps you use timers across multiple processes as well
